...
export const PAIR_DATA = {
  ...
  "23": { s: "average", t: "Wins over enemies but watch out for multiple / extra-marital relations, late marriage, child-conceiving issues." },
  "32": { s: "average", t: "Wins over enemies but watch out for multiple / extra-marital relations, late marriage, child-conceiving issues." },
  ...
  "34": { s: "good", t: "Spiritual learning, intuition and discipline — supportive for educators, researchers, occult / psychology / law fields." },
  ...
  "54": { s: "good", t: "Intelligent and creative — quick learner, good in communication, mediation, sales and analytical work." },
  ...
  "59": { s: "average", t: "Science / Commerce inclination — fewer but loyal relations, technical knowledge. Straightforward speech can hurt sometimes — be mindful." },
  "95": { s: "good", t: "Straight forward — person opts Science / Commerce stream. Less relations but good ones. Successful businessman. Immense technical knowledge." },
  ...
  "78": { s: "bad", t: "Spiritual / idealistic but lonely path — values & traditions strong; partnership, materialistic & married-life issues, repeated obstacles." },
  "87": { s: "bad", t: "Spiritual / idealistic but lonely path — values & traditions strong; partnership, materialistic & married-life issues, repeated obstacles." },
  ...
  // Same-digit pairs
  "11": { s: "good", t: "Double Sun — strong leadership, recognition, willpower, self-made identity." },
  "22": { s: "average", t: "Double Moon — emotional sensitivity, intuition, attractive personality but tends to overspend; mood swings possible." },
  "33": { s: "good", t: "Double Jupiter — wisdom, teaching ability, respect in society, spiritual depth, good advisor." },
  "44": { s: "bad", t: "Double Rahu — confusion, sudden losses, anxiety, joint / nerve / bone issues, accident-prone, legal entanglements." },
  "55": { s: "good", t: "Double Mercury — sharp intellect, brilliant communication, travel-loving, success in trade / media / writing / brokerage." },
  "66": { s: "good", t: "Double Venus — luxury, charm, art / music / design talent, harmonious relations, financial comfort." },
  "77": { s: "bad", t: "Double Ketu — isolation, anxiety, joint / knee / spine pain, career disruptions, reproductive / urinary issues." },
  "88": { s: "bad", t: "Double Saturn — heavy karma, delays, chronic health issues, separation in family, government / legal hurdles, depression." },
  "99": { s: "good", t: "Double Mars — courage, leadership, action-oriented, recognition, success after persistent effort." },
};
